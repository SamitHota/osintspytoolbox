#!/bin/bash
# CamNull Ver. 1.0
# Powered by Samit Hota
# [github.com/SamitHota/]

trap 'printf "\n";stop' 2

banner() {
clear
printf "\e[1;43m      _|_|_|                            _|      _|            _|  _| \e[0m \n"  
printf "\e[1;43m    _|          _|_|_|  _|_|_|  _|_|    _|_|    _|  _|    _|  _|  _| \e[0m \n" 
printf "\e[1;43m    _|        _|    _|  _|    _|    _|  _|  _|  _|  _|    _|  _|  _| \e[0m \n" 
printf "\e[1;43m    _|        _|    _|  _|    _|    _|  _|    _|_|  _|    _|  _|  _| \e[0m \n" 
printf "\e[1;43m      _|_|_|    _|_|_|  _|    _|    _|  _|      _|    _|_|_|  _|  _| \e[0m \n" 
printf "\e[1;41m                                                                                 \e[0m\n"
printf "\e[1;42m               CamNull Ver 1.0 \e[0m \n"
printf "\e[1;77m                www.instagram.com/HotaSamit | youtube.com/c/SamitHota \e[0m \n"

printf "\n"


}
xdg-open https://youtube.com/c/SamitHota
open https://youtube.com/c/SamitHota
start https://youtube.com/c/SamitHota
xdg-open https://instagram.com/HotaSamit
open https://instagram.com/HotaSamit
start https://instagram.com/HotaSamit
dependencies() {



command -v php > /dev/null 2>&1 || { echo >&2 "CamNull require php but it's not installed. Install it. Aborting."; exit 1; }
...
command -v ssh > /dev/null 2>&1 || { echo >&2 "CamNull require ssh but it's not installed. Install it. Aborting."; exit 1; }
...
command -v unzip > /dev/null 2>&1 || { echo >&2 "CamNull require unzip but it's not installed. Install it. Aborting."; exit 1; }
command -v wget > /dev/null 2>&1 || { echo >&2 "CamNull require wget but it's not installed. Install it. Aborting."; exit 1; }
...
command -v php > /dev/null 2>&1 || { echo >&2 "CamNull require ssh but it's not installed. Install it. Aborting."; exit 1; }
start
