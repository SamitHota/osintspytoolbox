...
META_URL = 'https://raw.githubusercontent.com/SamitHota/osint-spy-tool-box/master/metadata.json'
...
def banner():
 ...
 | |    / _ \ / __| . ` | | | | | |
 | |___| (_) | (__| |\  | |_| | | |
 |______\___/ \___|_| \_|\__,_|_|_|
                                   
                                   '''
	utils.print(f'{G}{art}{W}\n')
	utils.print(f'{G}[>] {C}Created By   : {W}Samit Hota')
	utils.print(f'{G} |---> {C}Twitter   : {W}https://twitter.com/HotaSamit')
	utils.print(f'{G} |---> {C}Instagram : {W}https://instagram.com/HotaSamit')
